...
},{"../internal/observable/dom/ajax":"../node_modules/rxjs/_esm5/internal/observable/dom/ajax.js","../internal/observable/dom/AjaxObservable":"../node_modules/rxjs/_esm5/internal/observable/dom/AjaxObservable.js"}],"demo.js":[function(require,module,exports) {
"use strict";
...
var numbers$ = (0, _rxjs.from)(numbers).pipe((0, _operators.tap)(console.log), (0, _operators.map)(function (n) {
  return {
    x: Math.pow(n, 2)
  };
}), (0, _operators.tap)(console.log), (0, _operators.filter)(function (obj) {
  return obj.x < 50;
}));
numbers$.subscribe(function (obj) {
  return console.log('observable from', obj);
}, function (e) {
  return console.error(e);
}, function () {
  return console.log("The stream is closed");
}); // numbers
//     .map(n => ({ x: Math.pow(n, 2) }))
//     .filter(obj => obj.x < 50)
//     .forEach(obj => console.log('array.map', obj));

var mousemove$ = (0, _rxjs.fromEvent)(square, 'mousemove').pipe((0, _operators.map)(function (e) {
  return {
    x: e.clientX
  };
}), (0, _operators.filter)(function (obj) {
  return obj.x < 50;
}));
mousemove$.subscribe(function (obj) {
  return console.log('observable fromEvent', obj);
...
var click$ = (0, _rxjs.fromEvent)(clickMe, 'click').pipe((0, _operators.concatMap)(function () {
  return _ajax.ajax.getJSON('/movies.json');
  ...
  return console.log('AJAX', value);
}, function (e) {
  return console.error(e);
}, function () {
  return console.log("The stream is closed");
});
(0, _rxjs.interval)(1000).pipe((0, _operators.take)(5)).subscribe(function (value) {
