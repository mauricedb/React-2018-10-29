...
listeners.push(function (v) {
  return console.log("The value is ".concat(v));
});
var a = createIncrement(5);
dispatch(a);
listeners.push(function (v) {
  return console.log("The second value is ".concat(v));
});
dispatch(createDecrement(3)); // console.log(store)

setTimeout(function () {
  return dispatch(createIncrement(123));
}, 1000);
